...
// Inportamos colors para darle color a nuestros console.log() en terminal
require('colors');
...
switch (command) {
    ...
    case 'Create':
        // Comando create ajecutado creo una nueva nota en mi tasks.md
        let task = tasks.createTask(argv.title, argv.description)
        console.log("Tarea created: ".blue, task)
        break;

        case 'update':
            // Comando create ejcuado creo una nueva nota en mi tasks.md
